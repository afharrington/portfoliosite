...
$("#about").bind("inview", function (isVisible) {
  ...
  if (isVisible) {
    $("#technical").fadeIn(800, function () {
      $("#creative").fadeIn(800, function () {
        $("#strategic").fadeIn(800, function () {
